...
class RotationSensorCard extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      switchActive: true,
  ...
  onNewMqttMessage = (topic, message) => {
    if(topic === this.state.mqttTopic) 
    {
      ...
      this.setState({ xValueData: [ ...this.state.xValueData, {"value": messageData.xVal} ] })
      this.setState({ yValueData: [ ...this.state.yValueData, {"value": messageData.yVal} ] })
      this.setState({ zValueData: [ ...this.state.zValueData, {"value": messageData.zVal} ] })
    }
  };
  ...
  render() {
    ...
    let chartDataSource = {
      ...
      "dataset": [
        {
          "seriesname": "X",
          "data": this.state.xValueData
        },
        {
          "seriesname": "Y",
          "data": this.state.yValueData
        },
        {
          "seriesname": "Z",
          "data": this.state.zValueData
        }
      ]
    }
...
RotationSensorCard.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(RotationSensorCard);