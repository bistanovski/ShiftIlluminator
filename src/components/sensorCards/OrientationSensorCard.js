...
class OrientationSensorCard extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      switchActive: true,
  ...
  onNewMqttMessage = (topic, message) => {
    if(topic === this.state.mqttTopic) 
    {
      ...
      this.setState({ orientationValueData: [ ...this.state.orientationValueData, {"value": messageData.orientation} ] })
    }
  };
  ...
  render() {
    ...
    let chartDataSource = {
      ...
      "dataset": [
        {
          "seriesname": "Orientation",
          "data": this.state.orientationValueData
        }
      ]
    }
...
OrientationSensorCard.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(OrientationSensorCard);