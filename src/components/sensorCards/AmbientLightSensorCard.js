...
class AmbientLightSensorCard extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      switchActive: true,
  ...
  onNewMqttMessage = (topic, message) => {
    if(topic === this.state.mqttTopic) 
    {
      ...
      this.setState({ ambientLightValueData: [ ...this.state.ambientLightValueData, {"value": messageData.lightLevel} ] })
    }
  };
  ...
  render() {
    ...
    let chartDataSource = {
      ...
      "dataset": [
        {
          "seriesname": "Ambient Light",
          "data": this.state.ambientLightValueData
        }
      ]
    }
...
AmbientLightSensorCard.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(AmbientLightSensorCard);