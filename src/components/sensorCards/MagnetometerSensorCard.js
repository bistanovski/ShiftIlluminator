...
class MagnetometerSensorCard extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      switchActive: true,
  ...
  onNewMqttMessage = (topic, message) => {
    if(topic === this.state.mqttTopic) 
    {
      ...
      this.setState({ xFluxData: [ ...this.state.xFluxData, {"value": messageData.xFlux} ] })
      this.setState({ yFluxData: [ ...this.state.yFluxData, {"value": messageData.yFlux} ] })
      this.setState({ zFluxData: [ ...this.state.zFluxData, {"value": messageData.zFlux} ] })
      this.setState({ calibrationData: [ ...this.state.calibrationData, {"value": messageData.calibrationLevel} ] })
    }
  };
  ...
  render() {
    ...
    let chartDataSource = {
      ...
      "dataset": [
        {
          "seriesname": "xFlux",
          "data": this.state.xFluxData
        },
        {
          "seriesname": "yFlux",
          "data": this.state.yFluxData
        },
        {
          "seriesname": "zFlux",
          "data": this.state.zFluxData
        },
        {
          "seriesname": "calibration level",
...
MagnetometerSensorCard.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(MagnetometerSensorCard);