...
class CompassSensorCard extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      switchActive: true,
  ...
  onNewMqttMessage = (topic, message) => {
    if(topic === this.state.mqttTopic) 
    {
      ...
      this.setState({ azimuthValueData: [ ...this.state.azimuthValueData, {"value": messageData.azimuth} ] })
      this.setState({ calibrationLevelValueData: [ ...this.state.calibrationLevelValueData, {"value": messageData.calibrationLevel} ] })
    }
  };
  ...
  render() {
    ...
    let chartDataSource = {
      ...
      "dataset": [
        {
          "seriesname": "Azimuth",
          "data": this.state.azimuthValueData
        },
        {
          "seriesname": "Calibration Level",
          "data": this.state.calibrationLevelValueData
        }
      ]
    }
...
CompassSensorCard.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(CompassSensorCard);